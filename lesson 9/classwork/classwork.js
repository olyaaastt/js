...
// divElement.style.borderStyle ='2px solid red'
//
//
...
//     title.classList.add('blue--border');
//     let block = document.createElement('div');
//     block.classList.add('row');
//     let monthDuration = document.createElement('div');
//
//     monthDuration.classList.add('blue--border');
...
//     hourDuration.classList.add('blue--border');
//     block.append(monthDuration, hourDuration);
//
//     let ul = document.createElement('ul');
//     ul.classList.add('blue--border');
//
...
//
//
//     divElement.append(title, block, ul)
// }
